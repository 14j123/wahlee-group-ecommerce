...
namespace Grand.Web.Areas.Admin.Services
{
    public partial class CategoryViewModelService : ICategoryViewModelService
    {
        ...
        public CategoryViewModelService(ICategoryService categoryService, ICategoryTemplateService categoryTemplateService, IDiscountService discountService, ICouponService couponService, 
        ...
        protected virtual void PrepareCouponModel(CategoryModel model, Category category, bool excludeProperties)
        {
            if (model == null)
                throw new ArgumentNullException("model");

            model.AvailableCoupons = _couponService
                .GetAllCoupons(CouponType.AssignedToCategories, showHidden: true)
                .Select(d => d.ToModel())
                .ToList();

            if (!excludeProperties && category != null)
            {
                model.SelectedCouponIds = category.AppliedCoupons.ToArray();
            }
        }
        ...
        public virtual CategoryModel PrepareCategoryModel()
        {
            ...
            //coupons
            PrepareCouponModel(model, null,true);
            //ACL
        ...
        public virtual CategoryModel PrepareCategoryModel(CategoryModel model, Category category)
        {
            ...
            //coupons
            PrepareCouponModel(model, category, false);
            return model;
        }
        ...
        public Category InsertCategoryModel(CategoryModel model)
        {
            ...
            var allCoupons = _couponService.GetAllCoupons(CouponType.AssignedToCategories, showHidden:true);
            ...
            {
                if (model.SelectedCouponIds != null && model.SelectedCouponIds.Contains(coupon.Id))
                    category.AppliedCoupons.Add(coupon.Id);
            }
