...
namespace Grand.Web.Areas.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseGrandEntityModel, ILocalizedModel<ProductLocalizedModel>, IAclMappingModel, IStoreMappingModel
    {
        public ProductModel()
        {
            ...
            AvailableRewardGiftCategory = new List<SelectListItem>();
        }
        ...
        [GrandResourceDisplayName("Admin.Catalog.Products.Fields.ShowOnHomePageTrending")]
        ...
        [GrandResourceDisplayName("Admin.Catalog.Products.Fields.DisplayOrder2")]
        public int DisplayOrder2 { get; set; }

        [GrandResourceDisplayName("Admin.Catalog.Products.Fields.DisplayOrder1")]
        public int DisplayOrderTrending { get; set; }
        ...
        public List<SelectListItem> AvailableRewardGiftCategory { get; set; }

        [GrandResourceDisplayName("Admin.Catalog.Products.Fields.Activate")]
        ...
        [GrandResourceDisplayName("Admin.Reward.Reward.Fields.PointRequire")]
        ...
        public string[] SelectedCouponIds { get; set; }
