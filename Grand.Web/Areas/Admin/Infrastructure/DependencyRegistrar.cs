...
namespace Grand.Web.Areas.Admin.Infrastructure
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, GrandConfig config)
        {
            ...
            builder.RegisterType<CouponViewModelService>().As<ICouponViewModelService>().InstancePerLifetimeScope();
            builder.RegisterType<EmailAccountViewModelService>().As<IEmailAccountViewModelService>().InstancePerLifetimeScope();

            builder.RegisterType<FlashSaleViewModelService>().As<IFlashSaleViewModelService>().InstancePerLifetimeScope();
