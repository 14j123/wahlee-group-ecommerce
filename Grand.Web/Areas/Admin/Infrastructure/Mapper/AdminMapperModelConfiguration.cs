    ...
    public class AdminMapperModelConfiguration : Profile, IMapperProfile
    {
        public AdminMapperModelConfiguration()
        {
            ...
            CreateMap<Coupon, CouponModel>()
                .ForMember(dest => dest.CouponTypeName, mo => mo.Ignore())
                .ForMember(dest => dest.TimesUsed, mo => mo.Ignore())
                .ForMember(dest => dest.PrimaryStoreCurrencyCode, mo => mo.Ignore())
                .ForMember(dest => dest.AddCouponRequirement, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableCouponRequirementRules, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableCouponAmountProviders, mo => mo.Ignore())
                .ForMember(dest => dest.CouponRequirementMetaInfos, mo => mo.Ignore())
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore())
                .ForMember(dest => dest.StartDate, mo => mo.MapFrom(x => x.StartDateUtc.ConvertToUserTime()))
                .ForMember(dest => dest.EndDate, mo => mo.MapFrom(x => x.EndDateUtc.ConvertToUserTime()));
            ...
            CreateMap<CouponModel, Coupon>()
                ...
                .ForMember(dest => dest.CouponLimitation, mo => mo.Ignore())
                .ForMember(dest => dest.CouponRequirements, mo => mo.Ignore())
                .ForMember(dest => dest.StartDateUtc, mo => mo.MapFrom(x => x.StartDate.ConvertToUtcTime()))
                .ForMember(dest => dest.EndDateUtc, mo => mo.MapFrom(x => x.EndDate.ConvertToUtcTime()));
            ...
            //tags categories
            CreateMap<LuckyDrawGiftGroupingManage, LuckyDrawGiftGroupingManageModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<LuckyDrawGiftGroupingManageModel, LuckyDrawGiftGroupingManage>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());

            //luckydrawgiftgrouping categories
            CreateMap<LuckyDrawGiftManage, LuckyDrawGiftModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<LuckyDrawGiftModel, LuckyDrawGiftManage>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());
            //PointWallet categories
            CreateMap<PointWallet, PointWalletModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<PointWalletModel, PointWallet>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());
            //PointWalletSummary categories
            CreateMap<PointWalletSummary, PointWalletSummaryModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<PointWalletSummaryModel, PointWalletSummary>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());
            //Reward categories
            CreateMap<Reward, RewardModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<RewardModel, Reward>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());
            //Reward Picture categories
            CreateMap<RewardPicture, RewardPictureModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<RewardPictureModel, RewardPicture>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());

            //RewardCategoty categories
            CreateMap<RewardCategory, RewardCategoryModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<RewardCategoryModel, RewardCategory>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());

            //RewardID categories
            CreateMap<RewardID, RewardSummaryModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<RewardSummaryModel, RewardID>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());

            //FlashSale Summary
            CreateMap<FlashSale, FlashSaleModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<FlashSaleModel, FlashSale>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());
          ...
          //RewardID categories
            CreateMap<PointSetting, PointSettingModel>()
            .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            CreateMap<PointSettingModel, PointSetting>()
            .ForMember(dest => dest.Id, mo => mo.Ignore());
