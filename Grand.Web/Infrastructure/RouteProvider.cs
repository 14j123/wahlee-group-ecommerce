...
namespace Grand.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            //new created by wey wenn for additional
            routeBuilder.MapLocalizedRoute("CustomerStoreLocation",
                            "customer/storelocation",
                            new { controller = "Customer", action = "storelocation" });
            ...
            routeBuilder.MapLocalizedRoute("LoginCheckoutAsGuest",
                          ...
                          //new { controller = "Customer", action = "Login", checkoutAsGuest = false });
            ...
            //flashSales All products
        
            routeBuilder.MapLocalizedRoute("FlashSaleAllProducts",
                            "FlashSaleAllProducts",
                            new { controller = "Product", action = "FlashSaleAllProducts" });
