...
namespace Grand.Web.Infrastructure.Cache
{
    ...
    public partial class ModelCacheEventConsumer :
        ...
        //FlashSales
        IConsumer<EntityInserted<FlashSale>>,
        IConsumer<EntityUpdated<FlashSale>>,
        IConsumer<EntityDeleted<FlashSale>>,
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        public const string HOMEPAGE_FLASHSALES_MODEL_KEY = "Grand.pres.flashSale.homepage-{0}-{1}";
        public const string FLASHSALE_BY_SYSTEMNAME__MODEL_KEY = "Grand.pres.flashSale.systemname-{0}-{1}";
        public const string FLASHSALES_PATTERN_KEY = "Grand.pres.flashSale";
        /// <summary>
        ...
        public void HandleEvent(EntityInserted<FlashSale> eventMessage)
        {
            _cacheManager.RemoveByPattern(FLASHSALES_PATTERN_KEY);
        }

        public void HandleEvent(EntityUpdated<FlashSale> eventMessage)
        {
            _cacheManager.RemoveByPattern(FLASHSALES_PATTERN_KEY);
        }

        public void HandleEvent(EntityDeleted<FlashSale> eventMessage)
        {
            _cacheManager.RemoveByPattern(FLASHSALES_PATTERN_KEY);
        }
