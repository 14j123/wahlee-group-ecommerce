...
namespace Grand.Web.Interfaces
{
    public partial interface IProductViewModelService
    {
        ...
        IList<ProductOverviewModel> PrepareProductsDisplayedOnHomePageTrending(int? productThumbPictureSize);
        ...
        FlashSaleModel PrepareFlashSale(FlashSale flashSale);
        List<FlashSaleModel> PrepareHomePageFlashSale();
        List<FlashSaleModel> PrepareHomePageCurrentFlashSale();
    }
}