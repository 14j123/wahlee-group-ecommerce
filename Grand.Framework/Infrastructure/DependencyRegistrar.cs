...
namespace Grand.Framework.Infrastructure
{
    ...
    {
        string username = "m360";
        string password = "!yUgIOH!!oHmyGOd!luFFyIsPiRATEkInG!";
        /// <summary>
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, GrandConfig config)
        {
            ...
            if (dataProviderSettings != null && dataProviderSettings.IsValid())
            {
                ...
                builder.Register<IMongoClient>(c => GetMongoAuthClient()).SingleInstance();
            ...
            builder.RegisterType<FlashSaleService>().As<IFlashSaleService>().InstancePerLifetimeScope();
            ...
            //WahLee
            builder.RegisterType<ConsecutiveLoginLogService>().As<IConsecutiveLoginLogService>().InstancePerLifetimeScope();
            builder.RegisterType<TokenService>().As<ITokenService>().InstancePerLifetimeScope();

            //WahLeeAdmin
            builder.RegisterType<PointWalletService>().As<IPointWalletService>().InstancePerLifetimeScope();
            builder.RegisterType<PointWalletSummaryService>().As<IPointWalletSummaryService>().InstancePerLifetimeScope();
            builder.RegisterType<RewardService>().As<IRewardService>().InstancePerLifetimeScope();
            builder.RegisterType<RewardIDService>().As<IRewardIDService>().InstancePerLifetimeScope();
            builder.RegisterType<RewardCategoryService>().As<IRewardCategoryService>().InstancePerLifetimeScope();
            builder.RegisterType<LuckyDrawGiftManageService>().As<ILuckyDrawGiftManageService>().InstancePerLifetimeScope();
            builder.RegisterType<LuckyDrawGiftGroupingManageService>().As<ILuckyDrawGiftGroupingManageService>().InstancePerLifetimeScope();
            builder.RegisterType<LuckyDrawGiftIDManageService>().As<ILuckyDrawGiftIDManageService>().InstancePerLifetimeScope();
            builder.RegisterType<PointSettingService>().As<IPointSettingService>().InstancePerLifetimeScope();


            builder.RegisterType<MemberCardService>().As<IMemberCardService>().InstancePerLifetimeScope();
            builder.RegisterType<MemberCardOrderService>().As<IMemberCardOrderService>().InstancePerLifetimeScope();
            builder.RegisterType<MemberCardTopUpHistoryService>().As<IMemberCardTopUpHistoryService>().InstancePerLifetimeScope();
            builder.RegisterType<MemberCardRenewalRecordService>().As<IMemberCardRenewalRecordService>().InstancePerLifetimeScope();
        ...
        public MongoClient GetMongoAuthClient()
        {
            ...
            string mongoHost = "35.185.190.169"; //127.0.0.1 //35.185.190.169
