namespace Grand.Services.Security
{
    public static class PermissionSystemName
    {
        ...
        public const string FlashSales = "ManageFlashSales";
        ...
        public const string Coupons = "ManageCoupons";
        ...
        public const string LoyaltyReward = "LoyaltyReward";
        public const string LoyaltyGiftReward = "LoyaltyGiftReward";
        public const string PointWallet = "PointWallet";
        public const string PointWalletSummary = "PointWalletSummary";
        public const string RewardCategory = "RewardCategory";
        public const string Reward = "Reward";
        public const string RewardPicutre = "RewardPicutre";
        public const string RewardSummary = "RewardSummary";

        public const string PointManage = "PointManage";
        public const string LoginReward = "LoginReward";
        public const string MemberCard = "MemberCard";

        public const string MemberCardTopUpHistory = "MemberCardTopUpHistory";
        public const string MemberCardRenewalRecord = "MemberCardRenewalRecord";
        public const string MemberCardOrder = "MemberCardOrder";

        
        //public const string Help2 = "Help2";
        //public const string Help3 = "Help3";
        public const string LuckyDrawGift = "LuckyDrawGift";
        public const string PointSetting = "PointSetting";
