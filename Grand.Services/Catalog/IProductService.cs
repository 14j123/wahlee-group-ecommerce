...
namespace Grand.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// <summary>
        /// 
        /// Gets all products displayed on the home page Trending
        /// </summary>
        /// <returns>Products</returns>
        IList<Product> GetAllProductsDisplayedOnHomePageTrending();
        ...
        /// <returns>Products</returns>
        IPagedList<Product> GetProductsByCoupon(string couponId, int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        void InsertCoupon(string couponId, string productId);
        void DeleteCoupon(string couponId, string productId);

        #endregion

        #region flashSale

        IPagedList<Product> GetProductsByFlashSale(string flashSaleId, int pageIndex = 0, int pageSize = int.MaxValue);
        void InsertFlashSaleProduct(string flashSaleId, string productId);
        void DeleteFlashSaleProduct(string flashSaleId, string productId);

        #endregion

        #region LuckyDrawGift
        Product GetLDGiftInfo(string id);
        #endregion
    }
}
