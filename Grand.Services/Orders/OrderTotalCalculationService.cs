...
namespace Grand.Services.Orders
{
    ...
    public partial class OrderTotalCalculationService : IOrderTotalCalculationService
    {
        ...
        //protected virtual decimal GetOrderSubtotalCoupon(Customer customer,
        //   decimal orderSubTotal, out List<AppliedCoupon> appliedCoupons)
        //{
        //    appliedCoupons = new List<AppliedCoupon>();
        //    decimal couponAmount = decimal.Zero;
        //    if (_catalogSettings.IgnoreCoupons)
        //        return couponAmount;

        //    var allCoupons = _couponService.GetAllCoupons(CouponType.AssignedToOrderSubTotal);
        ...
        //                coupon.CouponType == CouponType.AssignedToOrderSubTotal &&
        //                !allowedCoupons.Where(x => x.CouponId == coupon.Id).Any())
        //            {
        ...
        //    appliedCoupons = _couponService.GetPreferredCoupon(allowedCoupons, customer, orderSubTotal, out couponAmount);

        //    if (couponAmount < decimal.Zero)
        //        couponAmount = decimal.Zero;

        //    return couponAmount;
        //}

        //protected virtual decimal GetShippingCoupon(Customer customer, decimal shippingTotal, out List<AppliedCoupon> appliedCoupons)
        //{
        //    appliedCoupons = new List<AppliedCoupon>();
        //    decimal shippingCouponAmount = decimal.Zero;
        //    if (_catalogSettings.IgnoreCoupons)
        //        return shippingCouponAmount;

        //    var allCoupons = _couponService.GetAllCoupons(CouponType.AssignedToShipping);
        //    var allowedCoupons = new List<AppliedCoupon>();
        //    if (allCoupons != null)
        //        foreach (var coupon in allCoupons)
        //        {
        //            var validCoupon = _couponService.ValidateCoupon(coupon, customer);
        //            if (validCoupon.IsValid &&
        //                coupon.CouponType == CouponType.AssignedToShipping &&
        //                !allowedCoupons.Where(x => x.CouponId == coupon.Id).Any())
        //            {
        //                allowedCoupons.Add(new AppliedCoupon
        //                {
        ...
        //            }
        //        }
        //    appliedCoupons = _couponService.GetPreferredCoupon(allowedCoupons, customer, shippingTotal, out shippingCouponAmount);

        //    if (shippingCouponAmount < decimal.Zero)
        //        shippingCouponAmount = decimal.Zero;

        //    if (_shoppingCartSettings.RoundPricesDuringCalculation)
        //    {
        //        var currency = _currencyService.GetPrimaryExchangeRateCurrency();
        //        shippingCouponAmount = RoundingHelper.RoundPrice(shippingCouponAmount, currency);
        //    }
        //    return shippingCouponAmount;
        //}

        //protected virtual decimal GetOrderTotalCoupon(Customer customer, decimal orderTotal, out List<AppliedCoupon> appliedCoupons)
        //{
        //    appliedCoupons = new List<AppliedCoupon>();
        //    decimal couponAmount = decimal.Zero;
        //    if (_catalogSettings.IgnoreCoupons)
        ...
        //    var allCoupons = _couponService.GetAllCoupons(CouponType.AssignedToOrderTotal);
        //    var allowedCoupons = new List<AppliedCoupon>();
        //    if (allCoupons != null)
        //        foreach (var coupon in allCoupons)
        //        {
        ...
        //            }
        //        }
        //    appliedCoupons = _couponService.GetPreferredCoupon(allowedCoupons, customer, orderTotal, out couponAmount);
        ...
        //        couponAmount = RoundingHelper.RoundPrice(couponAmount, primaryCurrency);
        //    }
        //    return couponAmount;
        //}
