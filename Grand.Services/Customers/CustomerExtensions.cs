...
namespace Grand.Services.Customers
{
    public static class CustomerExtensions
    {
        ...
        /// <param name="customer">Customer</param>
        /// <returns>Coupon codes</returns>
        public static string[] ParseAppliedCouponTicketCodes(this Customer customer)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");

            var existingCouponCodes = customer.GetAttribute<string>(SystemCustomerAttributeNames.CouponTicketCode);
            ...
            try
            {
                ...
                var nodeList1 = xmlDoc.SelectNodes(@"//CouponTicketCodes/CouponCode");
                foreach (XmlNode node1 in nodeList1)
                {
                    if (node1.Attributes != null && node1.Attributes["Code"] != null)
                    {
        ...
        /// <param name="couponCode">Coupon code</param>
        /// <returns>New coupon codes document</returns>
        public static void ApplyCouponTicketCode(this Customer customer, string couponCode)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
            ...
            //apply new value
            genericAttributeService.SaveAttribute(customer, SystemCustomerAttributeNames.CouponTicketCode, result);
        ...
        /// <param name="couponCode">Coupon code to remove</param>
        /// <returns>New coupon codes document</returns>
        public static void RemoveCouponTicketCode(this Customer customer, string couponCode)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");

            //get applied coupon codes
            var existingCouponCodes = customer.ParseAppliedCouponTicketCodes();
            ...
            genericAttributeService.SaveAttribute<string>(customer, SystemCustomerAttributeNames.CouponTicketCode, null);
