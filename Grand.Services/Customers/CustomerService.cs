...
namespace Grand.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        #region Get All Valid Customer Email
        public virtual List<Customer> GetAllValidCustomerEmail()
        {
            var query = from c in _customerRepository.Table
                        where c.Active == true && c.Email != null
                        select c;
        ...
        #region Get Valid Customer by ID
        public virtual Customer GetValidCustomerById(string Id)
        {
            var query = from c in _customerRepository.Table
        ...
        #region Get Valid Customer by Member Card ID
        public virtual Customer GetCustomerIDByMemberCardId(string Id)
        {
            var query = from c in _customerRepository.Table
                        where c.Active == true && c.MemberCardId == Id
                        select c;
